...
idle = [tk.PhotoImage(file='Animations/idle.gif',format = 'gif -index %i' %(i)) for i in range(5)]#idle gif , 5 frames
idle_to_sleep = [tk.PhotoImage(file='Animations/idle_to_sleep.gif',format = 'gif -index %i' %(i)) for i in range(8)]#idle to sleep gif, 8 frames
sleep = [tk.PhotoImage(file='Animations/sleep.gif',format = 'gif -index %i' %(i)) for i in range(3)]#sleep gif, 3 frames
sleep_to_idle = [tk.PhotoImage(file='Animations/sleep_to_idle.gif',format = 'gif -index %i' %(i)) for i in range(8)]#sleep to idle gif, 8 frames
walk_positive = [tk.PhotoImage(file='Animations/walking_positive.gif',format = 'gif -index %i' %(i)) for i in range(8)]#walk to left gif, 8 frames
walk_negative = [tk.PhotoImage(file='Animations/walking_negative.gif',format = 'gif -index %i' %(i)) for i in range(8)]#walk to right gif, 8 frames
...
window.wm_attributes('-transparent', 1)
